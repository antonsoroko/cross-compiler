...
ENV MAC_SDK_VERSION 11.0

RUN apt-get install -y --force-yes apt-utils apt-transport-https libcurl4-openssl-dev libmpc-dev libmpfr-dev libgmp-dev
...
ENV CROSS_TRIPLE arm64-apple-darwin20
